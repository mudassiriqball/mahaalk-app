...
export default {
    [LOCALES.ENGLISH]: {
        ...
        'address': 'Address *',
        'address_without_asteric': 'Address',
        ...
        'place_order_error': 'Product quantity out of stock, change stock and try again',
        ...
        'login_failed': 'Login failed, check your number and password',
        'enter_different_values': 'Enter different values',
        'edit': 'Edit',
        'update': 'Update',
        'updating': 'Updating',
        'chose_image': 'Choose Image',
        'take_phote': 'Take Phote',
        'load_more': 'Load More',
        'sending': 'Sending',
        'my_mobile_number': '+966 59 091 1771',
        'next': 'Next',
        'email_place_holder': 'mr.x@gmail.com',
        'signup_successfull': 'Your account created successfully',
        'verify_number_first': 'Please verify your number first',
        'order_summary': 'Order Summary',
        'my_wishlist': 'My Wishlist',
        'deleting': 'Deleting...',
        'sinin_to_view_cart': 'Signin to view your cart.',
        'number_not_exists': 'Number does not exists',
        'back': 'Back',
        ...
        'personel_info_updated': 'Personel Info Updated Successfully',

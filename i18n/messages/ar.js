...
export default {
    [LOCALES.ARABIC]: {
        ...
        'address': '* العنوان',
        'address_without_asteric': 'العنوان',
        ...
        'login_failed': 'فشل تسجيل الدخول ، تحقق من رقمك وكلمة المرور',
        'enter_different_values': 'أدخل قيمًا مختلفة',
        'edit': 'تعديل',
        'update': 'تحديث',
        'updating': 'التحديث',
        ...
        'signup_successfull': 'تم إنشاء حسابك بنجاح',
        'verify_number_first': 'يرجى التحقق من رقمك أولا',
        'order_summary': 'ملخص الطلب',
        'my_wishlist': 'قائمة امنياتي',
        'deleting': '...حذف',
        'sinin_to_view_cart': 'تسجيل الدخول لعرض عربة التسوق الخاصة بك.',
        'number_not_exists': 'الرقم غير موجود',
        'back': 'عودة',
        'no_internet': 'لا يوجد اتصال بالإنترنت',
        'you_may_like': 'قد يعجبك',
        'continue': 'استمر',
        'add_cart_success': 'تم اضافة المنتجات الى العربة بنجاح',
        'removing': '...إزالة',
        'address_updated': 'تم تحديث العنوان بنجاح',
        'personel_info_updated': 'تم تحديث المعلومات الشخصية بنجاح',
